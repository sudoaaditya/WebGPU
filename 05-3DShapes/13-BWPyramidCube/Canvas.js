...
const initialize = () => {
    ...
    const vertex_position_cube = new Float32Array([
        ...
        // front
        1.0,  1.0,  1.0, 1.0, // top-right of front
        -1.0,  1.0,  1.0, 1.0, // top-left of front
        -1.0, -1.0,  1.0, 1.0, // bottom-left of front

        -1.0, -1.0,  1.0, 1.0, // bottom-left of front
        1.0, -1.0,  1.0, 1.0, // bottom-right of front
        1.0,  1.0,  1.0, 1.0, // top-right of front


        // right
        1.0,  1.0, -1.0, 1.0, // top-right of right
        1.0,  1.0,  1.0, 1.0, // top-left of right
        1.0, -1.0,  1.0, 1.0, // bottom-left of right
        
        1.0, -1.0,  1.0, 1.0, // bottom-left of right
        1.0, -1.0, -1.0, 1.0, // bottom-right of right
        1.0,  1.0, -1.0, 1.0, // top-right of right

        // back
        1.0,  1.0, -1.0, 1.0, // top-right of back
        -1.0,  1.0, -1.0, 1.0, // top-left of back
        -1.0, -1.0, -1.0, 1.0, // bottom-left of back

        -1.0, -1.0, -1.0, 1.0, // bottom-left of back
        1.0, -1.0, -1.0, 1.0, // bottom-right of back
        1.0,  1.0, -1.0, 1.0, // top-right of back


        // left
        -1.0,  1.0,  1.0, 1.0, // top-right of left
        -1.0,  1.0, -1.0, 1.0, // top-left of left
        -1.0, -1.0, -1.0, 1.0, // bottom-left of left

        -1.0, -1.0, -1.0, 1.0, // bottom-left of left
        -1.0, -1.0,  1.0, 1.0, // bottom-right of left
        -1.0,  1.0,  1.0, 1.0, // top-right of left

        // top
        1.0,  1.0, -1.0, 1.0, // top-right of top
        -1.0,  1.0, -1.0, 1.0, // top-left of top
        -1.0,  1.0,  1.0, 1.0, // bottom-left of top

        -1.0,  1.0,  1.0, 1.0, // bottom-left of top
        1.0,  1.0,  1.0, 1.0, // bottom-right of top
        1.0,  1.0, -1.0, 1.0, // top-right of top

        // bottom
        1.0, -1.0,  1.0, 1.0, // top-right of bottom
        -1.0, -1.0,  1.0, 1.0, // top-left of bottom
        -1.0, -1.0, -1.0, 1.0, // bottom-left of bottom

        -1.0, -1.0, -1.0, 1.0, // bottom-left of bottom
        1.0, -1.0, -1.0, 1.0, // bottom-right of bottom
        1.0, -1.0,  1.0, 1.0, // top-right of bottom
    ...
    const bufferDescriptor_position = {
        size: vertex_position_pyramid.byteLength,
        usage: GPUBufferUsage.VERTEX | GPUBufferUsage.COPY_DST,
    };

    // Create Position Buffer from Descriptor //! GPUBuffer
    buffer_position_pyramid = device.createBuffer(bufferDescriptor_position);
    if(!buffer_position_pyramid){
        console.log("Failed to create Position Buffer for Pyramid!");
        throw Error("Failed to create Position Buffer for Pyramid!");
    }
    else {
        console.log("Position Buffer Created Successfully for Pyramid!!..");
    }

    // Write data to Position Buffer
    queue.writeBuffer(buffer_position_pyramid, 0, vertex_position_pyramid, 0, vertex_position_pyramid.length);

    console.log("Position Buffer Data Written Successfully for Pyramid!!..");

    // MVP Uniform Buffer for Pyramid
    ...
    // Create Bind Group for MVP Uniform Buffer for Pyramid
    ...
    // Cube Position Buffer, Color Buffer, Bind Group and Pipeline Layout
    // Create Position Buffer Descriptor //! GPUBufferDescriptor
    const bufferDescriptor_position_cube = {
        size: vertex_position_cube.byteLength,
        usage: GPUBufferUsage.VERTEX | GPUBufferUsage.COPY_DST,
    };

    // Create Position Buffer from Descriptor //! GPUBuffer
    buffer_position_cube = device.createBuffer(bufferDescriptor_position_cube);
    if(!buffer_position_cube){
        console.log("Failed to create Position Buffer for Cube!");
        throw Error("Failed to create Position Buffer for Cube!");
    }
    else {
        console.log("Position Buffer Created Successfully for Cube!!..");
    }

    // Write data to Position Buffer
    queue.writeBuffer(buffer_position_cube, 0, vertex_position_cube, 0, vertex_position_cube.length);

    console.log("Position Buffer Data Written Successfully for Cube!!..");

    // MVP Uniform Buffer for Cube
    buffer_mvpUniform_cube = createUniformBuffer(mvpUniformSize, GPUBufferUsage.UNIFORM | GPUBufferUsage.COPY_DST);

    // Create Bind Group for MVP Uniform Buffer for Cube
